        ...
        jQuery.fn.KTDatatable = function (i) {
            if (0 !== $(this).length) {
                ...
                var r = {
                                ...
                                e(n).find(".kt-datatable__cell").each(function (a, n) {
                                    ...
                                    if (void 0 !== o) {
                                        ...
                                        if (void 0 !== o.subtable && o.subtable) {
                                            if (e(n).find(".kt-datatable__toggle-subtable").length > 0) return;
                    ...
                    recentNode: [],
                    table: function () {
                        if (void 0 !== l.table) return l.table
                    },
                    row: function (t) {
                ...
                if (e.each(r, function (t, e) {
                    ...
                    } else l.data(a) || e(this).hasClass("kt-datatable--loaded") || (l.dataSet = null, l.textAlign = {
                ...
                else void 0 === (l = e(this).data(a)) && e.error("KTDatatable not initialized"), i = l.options;
                return l
            }
